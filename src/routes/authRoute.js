...
router.post("/register",                     //............................register..............................
                         [
                          body('name').not().isEmpty().withMessage('Name is required').isLength({ min: 3 }).withMessage('Name must be at least 3 characters long'),
    ...
    try {
      ...
      res.status(201).json("Account created successfully with" + "  " + user.email);
    } catch (error) {
      console.log(error);
